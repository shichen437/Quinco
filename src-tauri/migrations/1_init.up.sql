...
INSERT INTO sys_workspace (name, type, is_current) VALUES ('Demo Workspace', 'demo', 1);
...
CREATE INDEX IF NOT EXISTS idx_ai_chat_sessions_wid_updated_at ON ai_chat_sessions(wid, updated_at DESC);
...
CREATE INDEX idx_ai_chat_messages_created_at ON ai_chat_messages(sid, created_at);
